const Projects = () => {
  return (
    <section className="py-16">
      <h2 className="text-3xl md:text-4xl text-quaternary-color text-center mb-16">
        Proyectos
      </h2>

      <div className="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-8 md:w-4/5 md:m-auto">
        <article className="bg-card-color py-12 px-8 border-b-2 border-transparent">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="icon w-24 mx-auto md:mx-0"
            viewBox="0 0 24 24"
          >
          ...
          <h3 className="text-2xl text-gray-color font-medium text-center md:text-left">
